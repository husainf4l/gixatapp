...
class AppColors {
  ...
  static const Color lightPrimaryContainer = Color(0xFFB2EBF2); // Soft Cyan
  ...
  // Dark Theme Colors
  static const Color darkPrimary = Color(0xFF0097A7); // Dark Cyan
  static const Color darkPrimaryContainer = Color(0xFF00BCD4); // Cyan
  ...
  static const Color darkOnPrimary = Color(0xFFE0F7FA); // Light Cyan for Text
